...
export default function Footer() {
  return (
    <footer className="bg-slate-900 text-slate-400 py-16 md:py-24 border-t border-slate-800 relative overflow-hidden">
      {/* Tło */}
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 mb-16">
          ...
          <div className="max-w-lg">
            <h3 className="text-white font-heading text-2xl font-extrabold mb-6 leading-tight">
              Agata Piątek — Ekspertka od Hiszpańskiego dla Polaków w Hiszpanii
            </h3>
            <p className="leading-relaxed text-slate-300 font-semibold mb-6">
            ...
            <p className="text-sm text-slate-500 font-bold">
              Magistra filologii hiszpańskiej, ponad 7 lat doświadczenia w nauczaniu.
            </p>
          </div>

          <div className="md:justify-self-end">
            <h4 className="text-white font-extrabold mb-6 text-lg tracking-tight">Skontaktuj się</h4>
            <div className="inline-flex flex-col gap-4">
              <a href="mailto:kontakt@ohiszpanski.pl" className="group flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-800 border border-slate-700 hover:border-primary/50 transition-colors w-full sm:w-auto">
                ...
                <ArrowUpRight className="w-4 h-4 text-slate-600 group-hover:text-primary transition-all" />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800/50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-semibold">
